...
(function(){
try {
   var timings = [ { marker: 'knitr', elapsed: 130 }, { marker: 'pandoc', elapsed: 230 }, { marker: 'post-processor', elapsed: 20 }, { marker: 'pre-processor', elapsed: 30 }, { marker: 'render', elapsed: 1330 } ];
